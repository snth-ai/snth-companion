...
const navItems = [
  ...
  { to: "/emotions", label: "Emotions", icon: HeartPulse },
  ...
  { to: "/coding-tools", label: "Coding Tools", icon: Code2 },
  { to: "/projects-v2", label: "Projects V2", icon: FolderGit2 },
  { to: "/integrations", label: "Integrations", icon: Cable },
  { to: "/realtime", label: "Real-Time", icon: Radio },
